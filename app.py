...
def get_response(user_query: str, db: SQLDatabase, chat_history: list):
    ...
    llm = ChatGroq(model = "llama-3.2-11b-text-preview", temperature=0)
...
with st.sidebar:
    ...
    st.text_input("Password", type = "password", value = "sri2003inmysql", key = "Password")
    st.text_input("Database",value="movie", key = "Database")
